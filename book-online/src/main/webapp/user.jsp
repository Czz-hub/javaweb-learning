...
<%--            <p>${user.createTime}加入</p>--%>
            ...
            <%
              LocalDateTime localDateTime = user.getCreateTime(); // 假设 createTime 是 LocalDateTime
              Date date = Date.from(localDateTime.atZone(ZoneId.systemDefault()).toInstant());
              SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd", java.util.Locale.CHINESE);
              String formattedTime = sdf.format(date);
            %>
            <p><%= formattedTime %> 加入</p>
